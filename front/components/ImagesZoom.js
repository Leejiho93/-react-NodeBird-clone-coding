...
const ImagesZoom = ({ images, onClose }) => {
    ...
    return (
        <div style={{ position: 'fixed', zIndex: 5000, top: 0, left: 0, rigth: 0, bottom: 0 }}>
            ...
            <div>
                <div style={{ height: 'calc(100% - 44px)', background: '#090909'}}>
                    ...
                    <div style={{ textAlign: 'center'}}>
                        <div style={{ width: 75, heigth: 30, lineHeight: '30px', borderRadius: 15, background: '#313131', display: 'inline-block', textAlign:'center', color: 'white', fontSize: '15px' }}>{currentSlide + 1} / {images.length}</div>
                    </div>
                </div>
            </div>
        </div>
